class Game {
  ...
  handleFuel(index) {
     ...
     cars[index - 1].overlap(fuels, function(collector, collect) {
       player.fuel = 185;
       // "collect" es el sprite en el grupo de coleccionables que detona
        // el evento
         collect.remove();
         });
         }
         ...
         handlePowerCoins(index) { 
          // Agregando monedas
           cars[index - 1].overlap(powerCoins, function(collector, collect) {
             player.score += 21;
              player.update();
              // "collect" es el sprite en el grupo de coleccionables que detona
               // el evento
